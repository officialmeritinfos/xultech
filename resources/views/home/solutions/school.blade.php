            ...
            <div class="col-lg-8">
                ...
                <div class="service-details_main-single">
                    ...
                    <p>
                        ...
                        where {{$siteName}}’s School Solutions come in. We take the chaos out of school administration and give
                ...
                <div class="service-details_main-single">
                    ...
                    <p>
                        ...
                        details manually. With {{$siteName}}’s Student Information System, you can manage everything related to
                ...
                <div class="service-details_main-single">
                    ...
                    <p>
                        Ah, school fees—the most dreaded topic for both parents and school accountants! But with {{$siteName}}’s
                ...
                <div class="service-details_main-single">
                    ...
                    <p>
                        The exam season can be hectic, but {{$siteName}} makes it easier for schools to handle exams and results
                ...
                <div class="service-details_main-single"> <h3 class="service-details_main-title">Why Your School Needs to Go Digital</h3> <p> Running a school involves handling piles of paperwork, from student records to fee tracking. Going digital with {{$siteName}} means saying goodbye to those stacks of files and freeing up your time for what really matters—education. Our digital solutions not only streamline processes but also save you significant costs on paper, printing, and administrative overhead. </p> <p> <strong>Cutting Down Paper Costs:</strong> Schools spend millions on paper, ink, and printing. By going digital, you eliminate much of this and streamline your operations.<br/> <strong>Reducing Errors:</strong> Automating tasks like grading and attendance ensures accuracy and removes the human error factor.<br/> <strong>Real-Time Access:</strong> Parents, teachers, and students can access everything from exam results to fee updates instantly online.<br/> <strong>Environmental Benefits:</strong> Reducing paper usage is not just cost-effective, it’s also environmentally friendly, contributing to a sustainable future. </p> <p> <strong>Who This Helps:</strong> School administrators, teachers, parents, and students who benefit from fast, accurate, and accessible data. </p> </div>

                <div class="service-details_main-single"> <h3 class="service-details_main-title">Why {{$siteName}}’s Result Management System Stands Out</h3> <p> The exam season doesn’t have to be a nightmare. {{$siteName}}’s Result Management System simplifies everything—from exam setup to grade calculation—making life easier for teachers, administrators, and students. No more manual grading or lost results, our automated system handles everything with precision. </p> <p> <strong>Key Features:</strong><br/> <strong>Automated Grading:</strong> Grades are entered into the system, and calculations are done instantly.<br/> <strong>Customizable Reports:</strong> Generate student performance reports and report cards in real time.<br/> <strong>Transparency:</strong> Both students and parents can access results online, improving communication and reducing errors. </p> <p> <strong>Who This Helps:</strong> Teachers, students, and parents who benefit from fast, accurate, and easy-to-access results. </p> </div>

                <div class="service-details_main-single">
                    <h3 class="service-details_main-title">Ready to Transform Your School?</h3>
                    <p>
                        If you're tired of juggling papers, spreadsheets, and outdated systems, let {{$siteName}} simplify the way
