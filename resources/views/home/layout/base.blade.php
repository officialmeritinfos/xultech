                ...
                <div class="col-lg-7 col-md-10 col-12" data-aos="fade-right" data-aos-duration="1000">
                    <div class="home-9_hero-content-block">
                        <div class="home-9_hero-text">
                            <h1 class="home-9_hero-title heading-xxl heading-xxl--syne text-black-3 fw-700">
                                Make better use of time by tracking it
                            </h1>
                            <p>
                                Masco time tracking software is a business application that helps you track work hours and increase your productivity
                                without wasting time on paper timesheets or complicated processes.
                            </p>
                        </div>
                        <div class="home-9_hero-button-group">
                            <a href="quote" class="btn-masco btn-primary-l09 rounded-pill btn-fill--down">Start Tracking Your Time…Now!</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row--custom">
                    <div class="col-xxl-7 col-xl-6 col-lg-6 col-md-7 col-10">
                        <div class="cta-text-block">
                            <h2 class="cta-home-9-title heading-lg heading-lg--syne">Ready to start tracking your time today?</h2>
                            <p>If you download Masco time-tracker for employee monitoring and project management software today, you'll get up to 14% off.</p>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="footer-v3__copyright-section copyright-border">
                ...
                <div class="footer-brand-wrapper">
                    <a href="index" class="footer-brand">
                        <img src="{{asset('home/image/logo-3-white.svg')}}" alt="logo" class="footer-brand__logo">
                    </a>
                </div>
                <!-- Copyright -->
